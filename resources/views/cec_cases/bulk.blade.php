                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> 
                        ...
                        <div class = "card-body">
                            ...
                            <form method="post" action="{{route('ces.number.generate.memebers.committee.room',@$id)}}">
                                @csrf
                            ...
                            <form method="post" action="{{route('ces.number.generate.memebers.committee.room.final-step-update')}}"> 
                                    @csrf
                                    ...
                                    <tr>
                                               ...
                                               <td>
                                                   <a type="button"
                                                        ...
                                                        <a class="btn btn-xs btn-danger" href="{{route('ces.number.generate.memebers.committee.room.delete.temp.member',['id'=>$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                                                                Delete
                                                            </a>
                                               </td>
            ...
            {{-- committe --}}
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('ces.number.generate.memebers.committee.room.add.temp.member') }}" enctype="multipart/form-data">@csrf
                                <input type="hidden" name="temp_id" value="{{@$id}}">
                                <div class="form-group">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('ces.number.generate.memebers.committee.room.update.temp.member') }}" enctype="multipart/form-data">@csrf
                                <input type="hidden" name="temp_id" value="{{@$id}}">
