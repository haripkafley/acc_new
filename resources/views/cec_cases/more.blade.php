        ...
        <ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <p><b>Total Score:</b> @if(@$data->scoring=="") --  @else {{@$data->scoring}} @endif</p>

                   @if(@$data->scoring!="")
                   <p><b>Complaint Score:</b> {{@$data->complaint_score}} </p>
                   <p><b>Financial Implication Score:</b> {{@$data->finance_score}} </p>
                   <p><b>Social Implication Score:</b> {{@$data->social_score}} </p>

                   <p><b>Outcome Status:</b> @if(@$data->outcome_status!=""){{@$data->outcome_status}} @if(@$data->outcome_status=="Share With Agencies") ({{@$data->agency_outcome}}) @endif @else -- @endif</p>
