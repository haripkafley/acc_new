...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <li class="nav-item">
          <a class="nav-link "  href="{{route('complaint.view.details.financial-implication-details',['id'=>@$id])}}">Financial Implication</a>
        </li>
          ...
          <a class="nav-link" href="{{route('complaint.view.details.case-link-details',['id'=>@$id])}}">Link Case</a>
            ...
            <div class="col-sm-6">
             ...
             <div class="col-sm-12">
                ...
                @if(@$data->regional_coi=="Y" || @$data->evalution_coi=="Y")
                <div class="col-sm-6">
                    <div class="card">
                    @if(@$data->assign_to=="H")
                       {{@$data->user_details_head->name}} Has  COI. 
                    @else
                        {{@$data->region_name->name}} has  COI . (Regional Office)
                    @endif
                </div>
                </div>
                @endif
        ...
        <form method="post" class="assign_form" action="{{route('assign.complaint.post')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-12 assignUsers_div" >
                    <div class="form-group">
                        <label>Assign Users<span style="font-weight: bold; color: red;">*</span></label>
                            <select class="form-control headquater_user_id" name="headquater_user_id">
                ...
                <div class="col-sm-12 regional_office_div"  style="display:none">
                    <div class="form-group">
        ...
        @else
            ...
            <form method="post" class="assign_form" action="{{route('assign.complaint.post.update')}}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="complaintID" value="{{@$id}}">
            <div class="row">
                <div class="col-sm-12">
                ...
                <div class="col-sm-12 assignUsers_div"  @if(@$data->assign_to=="H") style="display:block" @else style="display:none" @endif>
                    <div class="form-group">
                        <label>Assign Users<span style="font-weight: bold; color: red;">*</span></label>
                            <br>
                ...
                <div class="col-sm-12 regional_office_div" @if(@$data->assign_to=="R") style="display:block" @else style="display:none" @endif>
                    <div class="form-group">
                        <label>Regional Office<span style="font-weight: bold; color: red;">*</span></label>
                            <select class="form-control" name="regional_office">
                                @foreach(@$regional_office as $value)
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        e.preventDefault();
        var headquater_user_id = '{{@$data->headquater_user_id}}';
        
        if(headquater_user_id!='')
        {
            if(headquater_user_id==$('.headquater_user_id').val())
        {
            var c = confirm('Selected user already has coi. Are you sure want to assign the user again ?');
            if(c==true)
            {
                $('.assign_form').submit();
            }else{
