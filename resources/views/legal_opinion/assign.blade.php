...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              ...
                                              <a class="btn btn-xs btn-danger" href="{{route('legal.opinion.list.page.list.assign.official.delete.official',['id'=>@$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                                                                Delete
                                               </a>
                                               @endif
                                        </td>
        ...
        <form method="post" action="{{route('legal.opinion.list.page.list.assign.official.insert.official')}}" enctype="multipart/form-data">
            @csrf
