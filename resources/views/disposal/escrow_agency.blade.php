                                    ...
                                    <tr>
                                       ...
                                       <i class="fa fa-eye"></i>Attachment </a></td>
                                        <td>
                                                ...
                                                <a class="btn btn-xs btn-info edit_offence" data-id="{{@$att->id}}" data-agency="{{@$att->agency}}"  data-date="{{@$att->date}}" data-time="{{@$att->time}}" data-amount="{{@$att->amount}}" data-handed_over_to="{{@$att->handed_over_to}}" data-purpose="{{@$att->purpose}}" data-remarks="{{@$att->remarks}}" href="javascript:void(0)" data-><i class="fa fa-edit"></i>
                                                                Edit/View
                                                 </a>
                                        
                                                 <a class="btn btn-xs btn-danger" href="{{route('manage.get-assign-official-seized-properties.disposal.escrow.agency.details.delete',@$att->id)}}" onclick="return confirm('Are you sure , you want to delete this ? ')"><i class="fa fa-trash"></i>
                                                                Delete
                                                 </a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('manage.get-assign-official-seized-properties.disposal.escrow.agency.details.insert')}}">@csrf
               ...
               <div class="modal fade" id="offence_model_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('manage.get-assign-official-seized-properties.disposal.escrow.agency.details.update')}}">@csrf
