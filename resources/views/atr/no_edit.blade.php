...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <div class="card-body">
                    <a href="{{route('action.taken.report',@$data->action_id)}}" class="btn btn-primary" style="float: right;">
                        Back
                    </a>
                </div>
        ...
        <form method="post" action="{{route('action.taken.report.update.view')}}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{@$id}}">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Letter No<span style="font-weight: bold; color: red;">*</span></label>
                            <input class="form-control"  type="text" name="letter_no" value="{{@$data->letter_no}}" required>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Letter Date<span style="font-weight: bold; color: red;">*</span></label>
                            <input class="form-control"  type="date" name="letter_date" value="{{@$data->letter_date}}" required>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Reason<span style="font-weight: bold; color: red;">*</span></label>
                            <textarea class="form-control" style="height: 150px;" name="reason"> {{@$data->reason}} </textarea>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                <div class="form-group">
                <a class="btn btn-xs btn-info" href="{{URL::to('attachment/action')}}/{{$data->attach_letter}}" target="_blank"><i class="fa fa-eye"></i>View Attachment</a>
              </div>
             </div>
