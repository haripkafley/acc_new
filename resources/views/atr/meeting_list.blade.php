                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- @if($att->availability=="Y") --}}
                                                ...
                                                <a href="{{route('action.review.assign.committee.list.coi.details',['id'=>$att->id,'type'=>'cec'])}}" class="btn btn-warning">COI</a>
                                                @else
                                                <a href="{{route('action.review.assign.committee.list.case.details',['id'=>$att->id,'type'=>'cec'])}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                @endif
