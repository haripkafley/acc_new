        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    ...
                    <div id="casedetailscard" class="container-fluid">
                        <form method="post" action="{{route('action.taken.report.edit.view.yes.action.update')}}" enctype="multipart/form-data">
                        ...
                        <div class = "card-body">
                            <a href="{{route('action.taken.report.crud.add.view',@$id)}}" class="btn btn-primary" style="float: right;margin-bottom: 10px;">
                                    + Add Action
                                </a>
                            <table id  = "maintable" class="table" >
                                ...
                                <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <a href="{{route('action.taken.report.crud.edit.view',@$value->id)}}" class="bnt btn-info">Edit/View</a>
                                               <a href="{{route('action.taken.report.crud.delete.view',@$value->id)}}" class="bnt btn-danger">Delete</a>
                                           </td>
