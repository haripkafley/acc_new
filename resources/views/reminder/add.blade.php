...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
         ...
         <div class="card-body">
                    <a href="{{route('action.taken.reminder.list',@$id)}}" class="btn btn-primary" style="float: right;">
                        Back
                    </a>
                </div>
        ...
        <form method="post" action="{{route('action.taken.reminder.list.add.insert')}}" enctype="multipart/form-data">
            @csrf
