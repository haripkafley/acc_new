...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <li class="nav-item">
          <a class="nav-link"  href="{{route('complaint.view.details.financial-implication-details.regional',['id'=>@$id])}}">Financial Implication</a>
        </li>

        <li class="nav-item">
          <a class="nav-link active btn btn-info"  href="{{route('complaint.view.details.social-implication-details.regional',['id'=>@$id])}}">Social Implication</a>
        </li>
