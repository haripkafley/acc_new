                                       ...
                                       <tr>
                                           ...
                                           <td>
                                              ...
                                              @if(@$value->assign_status=="N")
                                               <a href="{{route('complaint.view.details.director',['id'=>@$value->complaintID])}}" class="btn btn-info" title="Assign"><i class="fas fa-user"></i></a>
                                               @else
                                               <a href="{{route('complaint.view.details.director',['id'=>@$value->complaintID])}}" class="btn btn-info" title="Reassign"><i class="fas fa-user"></i></a>
                                               @endif
