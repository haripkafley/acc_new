                        ...
                        <div class="row" style="font-family:Product Sans">
                            ...
                            <div class="col-sm">
                              <!-- Button trigger modal -->
                                ...
                                <a  href="{{route('manage.task-manage-case.add.task')}}" class="btn btn-primary" >
                                    Add Task
                                </a>
                            ...
                            <table id  = "maintableEvalDec" class="table" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>    
                                                <a href="{{route('manage.task-manage-case.edit.task',$att->id)}}" class="btn btn-success"><i class="fa fa-edit"></i> / <i class="fa fa-eye"></i></a>
                                           
                                                <a href="{{route('manage.task-manage-case.delete.task',$att->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
