...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <form method="post" action="{{route('recovery-model.cec.cases.list.coi.page.update.decision')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-6"><button type="submit" class="btn btn-info">Submit</button> <a onclick="location.reload()" class="btn btn-danger">Cancel</a></div>
