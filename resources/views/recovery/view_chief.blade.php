...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
            ...
            <div class="col-sm-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-xs btn-danger"
                                                        href="{{route('recovery-model.view.details.page.chief.delete.cec.member.data',@$att->id)}}"
                ...
                <div class="col-sm-12">
                        <div class="card">
                            <form action="{{route('recovery-model.view.details.page.chief.insert.cec.member.update.decision')}}" enctype="multipart/form-data" method="POST">
                                @csrf
            ...
            <div class="card" style="padding:25px;">
                        <form action="{{route('recovery-model.view.details.page.chief.insert.commission.member.update.decision')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{@$id}}">
            ...
            <div class="modal fade" id="exampleModa3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('recovery-model.view.details.page.chief.insert.cec.member') }}" enctype="multipart/form-data">@csrf
            ...
            <div class="modal fade" id="exampleModa3_edit_cec" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('recovery-model.view.details.page.chief.update.cec.member') }}" enctype="multipart/form-data">@csrf
                                <input type="hidden" name="monetory_id" value="{{@$id}}">
