                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">View Tacktical Request</h5>
                        ...
                        <div class="row"> 
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="type_ti" id="type_ti" disabled>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="request_type" id="request_type_edit" disabled>
                                    <option value="">Select</option>
                           ...
                           {{-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="requesting_officer" disabled id="requesting_officer">
                                    <option value="">Select</option>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="request_date" required class="form-control" disabled id="request_date">
                            </div>
                           </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="start_date" required class="form-control" disabled id="start_date">
                            </div>
                           </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="end_date" required class="form-control" disabled id="end_date">
                            </div>
                           </div>
                           ...
                           <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="suspect_details" id="suspect_details" disabled required class="form-control"></textarea>
                            </div>
                           </div>
                           ...
                           <div class="col-md-12">
                            <div class="form-group">
                                <label>Reasons</label>
                                <textarea type="text" name="reason" id="reason" disabled required class="form-control"></textarea>
                            </div>
                           </div>
