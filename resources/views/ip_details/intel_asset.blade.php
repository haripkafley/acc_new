                                ...
                                <tbody>
                                    @if($entityasset->count())
                                        ...
                                        <tr>   
                                            ...
                                            &nbsp; <a style="color:gray" href="{{ route('member.get.information.report.assignment.entities.asset.manage.delete.asset',$asset->id) }}" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return confirm('Are you sure you want to delete this record?') || event.preventDefault();"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                        @endforeach
                                    @else
                                        <tr>
...
<!-- end -->
<!--add modal -->
<form method = "POST" action="{{ route('member.get.information.report.assignment.entities.asset.manage.save.asset') }}"  enctype="multipart/form-data" >
@csrf    
...
<script>
    ...
    function gettoken()
       ...
       function getVehicleDetailsByCID(){
        ...
        var url = '{{ route("member.get.information.report.assignment.entities.asset.manage.show.asset", ":id") }}';
