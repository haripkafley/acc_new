                    ...
                    <div class="card-header" style="font-family:Product Sans"> 
                        ...
                        <div class="row" style="font-family:Product Sans">
                            ...
                            <div class="col-sm">
                              ...
                              <div class="row"><div class="col-md-12 text-right"><a class=" active btn btn-success text-left"  href="{{route('ip.commission.member.get.request')}}"> Back</a></div></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 card-body">
                                ...
                                <p><b>Date</b> : {{@$data->activity_date}}</p>
                        ...
                        <div class="row">
                            <div class="col-md-12 card-body">
                                <form method="post" action="{{route('ip.commission.member.get.request.view.details.update.decision')}}">
                                    @csrf
                                    <input type="hidden" name="id" value="{{@$id}}">
                                    <div class="form-group">
                                        <label>Decision</label>
                                        <select name="status" class="form-control">
                                            <option value="AA" @if(@$memberDetails->status=="AA") selected @endif)> Awaiting Approval</option>
                                            <option value="A" @if(@$memberDetails->status=="A") selected @endif> Accept</option>
                                            <option value="R" @if(@$memberDetails->status=="R") selected @endif> Reject</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="remarks" required>{{@$memberDetails->remarks}}</textarea>
                                    </div>
