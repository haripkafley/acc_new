                                    ...
                                    @if($entityorganization->count())
                                        @foreach ($entityorganization as $organization)
                                            <tr>   
                                                ...
                                                &nbsp;
                                                    <a style="color:gray" href="{{ route('member.get.information.report.assignment.entities.organization.manage.delete.organization',$organization->id) }}" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return confirm('Are you sure you want to delete this record?') || event.preventDefault();"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                        @endforeach
                                        @else
                                            <tr>
...
<!--add modal -->
<form method = "POST" action="{{ route('member.get.information.report.assignment.entities.organization.manage.insert.data') }}" enctype="multipart/form-data">
    @csrf  
