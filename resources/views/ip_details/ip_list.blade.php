        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> Ongoing Information Protocol </div>
                        <div class = "card-body">
                            ...
                            <table id  = "maintable" class="table" >
                                ...
                                <tbody>
                                       ...
                                       @php
                                        $check = DB::table('ir_form_team_member')->where('ir_id',$value->id)->where('coi_status','Y')->first();
                                       @endphp
                                       <tr @if(@$check!="") style="background-color:red;color: white;" @endif>
                                           ...
                                           <td @if(@$check!="") style="background-color:red;color: white;" @endif>{{@$value->area_name->area_name}}</td>
                                           ...
                                           <td>
                                               ...
                                               <a href="{{route('information.report.form.team.member',['id'=>@$value->id])}}" class="btn btn-success mt-2">Assign Member</a>
