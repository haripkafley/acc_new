@foreach ($entitydetailsshow as $showentitydtls)
    ...
    <input type="hidden" name="personcasenoidadd" value="{{$showentitydtls->ip_id}}">
    <div class="row">
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" name="persontype"  class="form-control" id="nationality" value="{{ $showentitydtls->type }}"  required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
