                        ...
                        <div class = "card-body">
                            ...
                            <table id  = "maintableEvalDec" class="table" >
                                ...
                                <tbody>
                                    ...
                                    <tr @if($att->brief_agency_status_assign=="IN") style="background-color:red;color:white" @endif>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{route('appraise.agency.review.list.decision.view',$att->id)}}" class="btn btn-warning"><i class="fa fa-eye"></i></a>
