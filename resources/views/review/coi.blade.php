...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <p><b>Allegation Name:</b> {{@$data->eve_offence_details->allegation_name}}</p>



                    {{-- <p><b>Complaint Decription:</b> {{@$data->complaint_details->complaintDesc}}</p> --}}
        ...
        <form method="post" action="{{route('assign.review.complaint.listing.coi.make-desicion')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-6"><button type="submit" class="btn btn-info">Submit</button> <a href="{{route('assign.review.complaint.listing')}}" class="btn btn-danger">Cancel</a></div>
