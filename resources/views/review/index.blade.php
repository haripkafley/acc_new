                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{route('assign.review.complaint.listing.coi',$att->id)}}" class="btn btn-warning">COI</a>
                                                @else
                                                <a href="{{route('assign.review.complaint.listing.activity',$att->id)}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                @endif
