...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <p><b>Complaint Decription:</b> {!!@$data->complaintDetails!!}</p>
        ...
        <form method="post" action="{{route('assign.review.team.by.chief.coi.decision.insert')}}" enctype="multipart/form-data">
            @csrf
