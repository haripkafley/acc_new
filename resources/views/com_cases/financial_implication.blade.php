...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link active btn btn-info"  href="{{route('commission-casescase-details.listing.details.financial-implication-details',['id'=>@$id])}}">Financial Implication</a>
        </li>
