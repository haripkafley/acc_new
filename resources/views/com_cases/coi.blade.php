    ...
    <div id="casedetailscard" class="container-fluid">
        ...
        <ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card">
                    <p><b>Complaint No:</b> {{@$data->complaint_details->complaintRegNo}}</p>

                    <p><b>Complaint TItle:</b> {{@$data->complaint_details->complaintTitle}}</p>

                    <p><b>Date Time:</b> {{@$data->complaint_details->complaintDateTime}}</p>
        ...
        <form method="post" action="{{route('commission-cases.listing.coi.make-desicion')}}" enctype="multipart/form-data">
            @csrf
