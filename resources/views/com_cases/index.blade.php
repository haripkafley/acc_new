                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- @if($att->availability=="Y") --}}
                                                ...
                                                <a href="{{route('commision.cases.listing.coi',$att->id)}}" class="btn btn-warning">COI</a>
                                                @else
                                                <a href="{{route('commission-cases.listing.details',$att->id)}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                @endif
