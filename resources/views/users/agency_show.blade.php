            ...
            <div class    = "card">
              ...
              <table id = "example1" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><a class  = "btn btn-warning" href="{{ route('deleteagency',$agency->agency_name_id) }}" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fa fa-minus"></i></a></td>
                </tr>
				@endforeach
            </tbody>
         </table>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Agency&nbsp;<font color='red'>*</font></label>
