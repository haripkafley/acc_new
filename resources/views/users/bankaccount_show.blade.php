            ...
            <div class    = "card">
              ...
              <table id = "example1" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><a class  = "btn btn-warning" href="{{ route('deletebankaccount',$bank->acc_id) }}" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fa fa-minus"></i></a></td>
                </tr>
				@endforeach
            </tbody>
         </table>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bankaccount_add"  class="form-control" id="bankaccount_add">
