                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-xs btn-danger"
                                                        href="{{ route('case.administrative.referrals.followup.action.taken.by.agency.delete.data', ['id' => @$att->id]) }}"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.action.taken.by.agency.insert.data')}}">@csrf
