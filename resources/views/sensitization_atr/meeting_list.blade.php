                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> 
                        ...
                        <div class = "card-body">
                            ...
                            <form method="post" id="form_submit" action="{{route('sensitization.review.assign.committee.list.update.availability')}}">
                                @csrf  
                            ...
                            <table id  = "maintableEvalDec" class="table" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>{{ $att->complaint_details->cec_date}}</td>
                                        <td>{{ $att->complaint_details->cec_time}}</td>
                                        <td>{{ $att->complaint_details->cec_venue}}</td>
                                        ...
                                        <td>
                                            {{-- @if($att->availability=="Y") --}}
                                                ...
                                                <a href="{{route('sensitization.review.assign.committee.list.coi.details',['id'=>$att->id,'type'=>'cec'])}}" class="btn btn-warning">COI</a>
                                                @else
                                                <a href="{{route('sensitization.review.assign.committee.list.case.details',['id'=>$att->id,'type'=>'cec'])}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                @endif
