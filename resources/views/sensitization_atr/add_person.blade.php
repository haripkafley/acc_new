...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <a href="{{route('sensitization.action.taken.report.edit.view.yes.action',@$id)}}" class="btn btn-primary" style="float: right;margin-bottom: 10px;">
                                    Back
                                </a>

        <form method="post" action="{{route('sensitization.action.taken.report.crud.insert')}}" enctype="multipart/form-data">
            @csrf
