                                    ...
                                    @if (@$members->isNotEmpty())
                                        @foreach (@$members as $att)
                                            <tr>
                                                ...
                                                {{-- <td><a href="{{route('member.details.on.cases.senstization.details',@$att->id)}}" class="btn btn-primary" target="_blank">View More</a></td> --}}
...
{{--           <div class="col-sm-12">
            <div class="card">
                        <form action="{{route('sensitization.review.assign.committee.list.case.details.update.decision')}}" enctype="multipart/form-data" method="POST">
                                @csrf
