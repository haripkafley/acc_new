...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <a href="{{route('sensitization.action.taken.report.edit.view.yes.action',@$atr_id)}}" class="btn btn-primary" style="float: right;margin-bottom: 10px;">
                                    Back
                                </a>
        <form method="post" action="{{route('sensitization.action.taken.report.crud.update')}}" enctype="multipart/form-data">
            @csrf
            


            <input type="hidden" name="id" value="{{@$data->id}}">
            <input type="hidden" name="atr" value="{{@$atr_id}}">
            <div class="row">
                <div class="col-sm-12">
