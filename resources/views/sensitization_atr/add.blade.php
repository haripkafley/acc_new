...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <div class="card-body">
                    <a href="{{route('sensitization.action.taken.report',@$id)}}" class="btn btn-primary" style="float: right;">
                        Back
                    </a>
                </div>
        ...
        <form method="post" action="{{route('sensitization.action.taken.report.add.view.action-insert.for.no.action')}}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="action_id" value="{{@$id}}">
            <div class="row">
