        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> Information Enrichment Cec </div>
                        <div class = "card-body">
                                ...
                                <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               ...
                                               <a href="{{route('information.enrichment.get.user.list.cec.com.list.view',['type'=>'cec','id'=>@$value->id])}}" class="btn btn-danger">View</a>
                                               @endif
