                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                            ...
                                                            <a class="btn btn-xs btn-danger" href="{{route('information.enrichment.get.list.assigned.ie.delete.person.contact',['id'=>@$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('information.enrichment.get.list.assigned.ie.insert.person.contact')}}">@csrf
            ...
            <div class="modal fade" id="exampleModaEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('information.enrichment.get.list.assigned.ie.update.person.contact')}}">@csrf
            ...
            <div class="modal fade" id="exampleModa4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('information.enrichment.get.list.assigned.ie.insert.document.contact')}}">@csrf
            ...
            <div class="modal fade" id="exampleModa4_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('information.enrichment.get.list.assigned.ie.update.document.contact')}}">@csrf
