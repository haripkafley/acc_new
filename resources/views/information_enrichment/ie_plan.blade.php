    ...
    <div id="casedetailscard" class="container-fluid">
             ...
             <div class="col-sm-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                            ...
                                                            <a class="btn btn-xs btn-danger" href="{{route('information.enrichment.get.list.assigned.ie.plan.page.delete.data',['id'=>@$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                                                                
                                                            </a>


                                                            <a class="btn btn-xs btn-warning" href="{{route('information.enrichment.get.list.assigned.ie.update.page',['id'=>@$att->id])}}">Update
                                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                            ...
                                                            <a class="btn btn-xs btn-danger" href="{{route('information.enrichment.get.list.assigned.feild.plan.page.delete.data',['id'=>@$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                                                            </a>

                                                            <a class="btn btn-xs btn-warning" href="{{route('information.enrichment.get.list.assigned.field.update.page',['id'=>@$att->id])}}">Update
                                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-header" style="font-family:Product Sans"> Information Enrichment Report </div>
                        ...
                        <div class = "card-body">
                            <form action="{{route('information.enrichment.get.list.assigned.update.final.report')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <input type="hidden" name="ie_id" value="{{@$ir_id}}">
                                <div class="form-group">
                                    <label>Report Attachment</label>
                                    <input type="file" name="ie_report_attachment" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="ie_report_remakrs" class="form-control">{{@$offence_details->ie_report_remakrs}}</textarea>
                                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">New IE Plan Activity</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('information.enrichment.get.list.assigned.ie.plan.page.insert.data')}}">@csrf

                                <input type="hidden" name="ir_id" value="{{@$ir_id}}">
                                <div class="form-group">
            ...
            <div class="modal fade" id="exampleModaEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit IE Plan Activity</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="modal fade" id="exampleModa3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">New IE Plan and Field Visits</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('information.enrichment.get.list.assigned.feild.plan.page.insert.data')}}">@csrf
