                            ...
                            <table id  = "maintableEvalDec" class="table" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <a href="{{route('manage.own.prosecution.chief.assign.official.view',$att->id)}}" class="btn btn-warning">@if(@$att->assign_id_own=="") <i class="fa fa-user" title="Assign"></i> @else <i class="fa fa-user" title="Reassign"></i> @endif</a>

                                                <a href="{{route('manage.own.prosecution.chief.chamber.view',$att->id)}}" class="btn btn-info"><i class="fa fa-eye"></i></a>
