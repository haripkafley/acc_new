                    ...
                    <div class="card-body">
                            ...
                            <form action="{{route('own.prosecution.get.assign.official.case.prosecution.status.page.update')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" required name="judge_court" id="judge_court">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <select class="form-control" required name="judge_decision" id="judge_decision">
                                      <option value="">Select</option>
                                ...
                                <div class="judge_yes" @if(@$data->judge_decision=="Yes") style="display:block" @else style="display:none" @endif>
                                 <div class="form-group">
                                  ...
                                  <input type="date" name="judge_date" class="form-control" value="{{@$data->judge_date}}" id="judge_date">
                                 </div>

                                 <div class="form-group">
                                  <label for="exampleInputEmail1">Judgement No</label>
                                  <input type="text" name="judge_no" value="{{@$data->judge_no}}" class="form-control" id="judge_no">
                                 </div>


                                 <div class="form-group">
                                  <label for="exampleInputEmail1">Prosecuting Agency</label>
                                  <select class="form-control"  name="judge_agency">
                                      <option value="">Select</option>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <textarea class="form-control"  name="judge_remarks" id="judge_remarks">{{@$data->judge_remarks}}</textarea>
                                 </div>

                                 <div class="form-group">
                                  <label for="exampleInputEmail1">Judgement Attachment</label>
                                  <input type="file" class="form-control"  name="judge_attachment" id="judge_attachment">
                                 </div>
