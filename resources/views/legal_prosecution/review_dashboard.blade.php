                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                         ...
                         <div class="form-group">
                          ...
                          <textarea class="form-control" name="investigation_finding" id="investigation_finding"></textarea>
                         </div>
                         ...
                         <div class="form-group">
                          ...
                          <textarea class="form-control" name="recomendation" id="recomendation"></textarea>
                         </div>
