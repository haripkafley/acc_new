                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @php
                                            $restitution_prayed = \App\Models\RestitutionPrayed::where('case_id',@$case_id)->where('user_id',$att->id)->with('probable_charge_details')->get();
                                            @endphp
                                        ...
                                        <td>
                                            ...
                                            @php
                                            $confiscation_prayed = \App\Models\ConfiscationPrayed::where('case_id',@$case_id)->where('user_id',$att->id)->with('probable_charge_details')->get();
                                            @endphp
                                        ...
                                        @php
                                            $status = \App\Models\Legal\ProsecutionStatus::where('case_id',@$case_id)->where('type','R')->where('user_id',$att->id)->where('user_id',$att->id)->first();  
                                        @endphp
                                        
                                        <td>
                                            <p>{{@$status->status}}</p>
                                            <a href="javascript:void(0)" data-user_id_status="{{@$att->id}}" data-id="{{@$status->id}}" data-agency="{{@$status->agency_name}}" data-date="{{@$status->date}}" data-attachment="{{URL::to('attachment/legal_prosecution')}}/{{@$status->attachment}}" data-attach="{{@$status->attachment}}" data-status="{{@$status->status}}" data-status_remark="{{@$status->remarks}}" class="btn btn-warning status_button">View Status</a>
                                        </td>
                    ...
                    <div class="modal-content">
                        ...
                        <input type="hidden" name="id" id="id_status">
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control" name="agency_name" id="agency_name" disabled>
