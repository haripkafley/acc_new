        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans">  ASSIGNMENT </div>
                        <div class = "card-body">
                            ...
                            <table id  = "maintable" class="table" >
                                ...
                                <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                                @if(@$value->status=="AA") Pending @elseif(@$value->status=="DP") Drop @elseif(@$value->status=="SR") Share @elseif(@$value->status=="DR") Defer @else Upgrade To Ip @endif
                                           </td>                                          
