        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> ONGOING ASSIGNMENT </div>
                        <div class = "card-body">
                            ...
                            <table id  = "maintable" class="table" >
                                ...
                                <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>@php
                                                $explode = explode(',',@$value->ir_details->report_by);
                                            ...
                                            @foreach(@$selected_user as $user)
                                                ...
                                                @if (!$loop->last)
                                                    ,
                                                    @endif
                                            @endforeach - {{@$value->ir_details->date}}</td>
