...
@if($asset->asset_type == "Land")
    ...
    @endif
        ...
        @endif
        @foreach($freezedtls as $fredtls)
            @if($asset->status == "Frozen")
            <div class="row">
                    <div class   = "col-md-4">
                        <div class  = "form-group">
                            <label for   = "exampleInputEmail1">Freeze Date&nbsp;</label>
                                {{ \Carbon\Carbon::parse($fredtls->freeze_date)->format('d/m/Y')}}
                        </div>
                    </div>
                    <div class   = "col-md-4">
                        <div class  = "form-group">
                            <label for   = "exampleInputEmail1">Freeze Details&nbsp;</label>
                                {{ $fredtls->freeze_details }}
                        </div>
                    </div>
                </div>
            @endif
