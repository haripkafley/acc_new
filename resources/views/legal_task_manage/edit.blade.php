            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header" style="font-family:Product Sans">
                            ...
                            <div class="row" style="font-family:Product Sans">
                                ...
                                <div class="col-sm">
                                    ...
                                    <a href="{{route('manage.task.management.legal.chief')}}" style="float:right;" class="btn btn-primary">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('manage.task.management.legal.chief.update.task') }}">@csrf
