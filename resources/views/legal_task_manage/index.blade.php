                        ...
                        <div class="row" style="font-family:Product Sans">
                            ...
                            <div class="col-sm">
                              <!-- Button trigger modal -->
                                ...
                                <a  href="{{route('manage.task.management.legal.chief.add.task')}}" class="btn btn-primary" >
                                    Add Task
                                </a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{route('manage.task.management.legal.chief.edit.task',$att->id)}}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                           
                                                <a href="{{route('manage.task.management.legal.chief.delete.task',$att->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
