...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(@$check->report_status!="A")
                                            <a style="color:grey" href="{{ route('tacktical.inteligence.autorization.individual.ti-entity.information.page.delete.data',$person->id) }}" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return confirm('Are you sure you want to delete this record?') || event.preventDefault();"><i class="fa fa-trash"></i></a> &nbsp;
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
     ...
     <!-- ADD Person -->
   <form  method = "POST" action="{{ route('tacktical.inteligence.autorization.individual.ti-entity.information.page.insert.data') }}" enctype="multipart/form-data">
    @csrf 
...
<script>
    ...
    function getDetailsByCID(){
        ...
        var url = '{{ route("tacktical.inteligence.autorization.individual.ti-entity.information.page.view.data", ":id") }}';
        ...
        function checkcid(id) {
            ...
            var url = '{{ route("tacktical.inteligence.autorization.individual.ti-entity.information.page.checkCIDaddentity", [":cid", ":id"]) }}';
