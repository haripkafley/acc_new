        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> INFORMATION GATHERING ASSIGNMENT </div>
                        <div class = "card-body">
                                ...
                                <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               ...
                                               @else
                                               <a href="{{route('tacktical.inteligence.autorization.individual.details.page',['id'=>@$value->tacktical_id ])}}" class="btn btn-success">@if(@$value->tacktical_details->report_status!="A")+ Details Add @else View Details @endif</a>
                                               @endif
                                           </td>
