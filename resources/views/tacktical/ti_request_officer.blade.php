                        ...
                        <div class="row" style="font-family:Product Sans">
                            ...
                            <div class="col-sm">
                              <!-- Button trigger modal -->
                                ...
                                <a href="{{route('tacktical.inteligence.autorization.form.add')}}" class="btn btn-primary">
                                    + Add Request
                                </a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                            ...
                                                            @if(@$att->recommend_by=="")
                                                            <a class="btn btn-xs btn-success" href="{{route('tacktical.inteligence.autorization.form.edit',['id'=>$att->id])}}" ><i class="fa fa-edit"></i>
                                                                 
                                                            </a>


                                                            <a class="btn btn-xs btn-danger" href="{{route('tacktical.inteligence.autorization.form.delete',['id'=>$att->id])}}" ><i class="fa fa-trash"></i>
