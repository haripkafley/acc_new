...
<ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link active btn btn-info"  href="{{route('director.complaint.decision.listing.details.financial-implication-details',['id'=>@$id])}}">Financial Implication</a>
        </li>
