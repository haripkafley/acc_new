...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <li class="nav-item">
          <a class="nav-link active btn btn-info" href="#">Assign Member</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                    <p><b>Complaint No:</b> {{@$details->eve_offence_details->complaint_details->complaintRegNo}}</p>

                    <p><b>Complaint TItle:</b> {{@$details->eve_offence_details->complaint_details->complaintTitle}}</p>

                    <p><b>Date Time:</b> {{@$details->eve_offence_details->complaint_details->complaintDateTime}}</p>

                    <p><b>Offence Name :</b> {{@$details->eve_offence_details->allegation_name}}</p>
                    <p><b>Offence Description :</b> {{@$details->eve_offence_details->allegation_description}}</p>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              ...
                                              <a class="btn btn-xs btn-danger" href="{{route('recovery-model.cheif.official.delete.member',['id'=>@$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                                                                Delete
                                               </a>
                                               @endif
                                        </td>
        ...
        <form method="post" action="{{route('recovery-model.cheif.add.official.insert.member.insert')}}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="monetary_id" value="{{@$id}}">
            <div class="row">
                <div class="col-sm-12">
