    ...
    <div class="col-sm-12">
                        ...
                        <div class = "card-body">
                            ...
                            <table id  = "maintable" class="table" >
                                ...
                                <tbody>
                                    @if(@$covicted->isNotEmpty())
                                    @foreach(@$covicted as $att)
                                    <tr>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                         ...
                         <div class="form-group">
                          ...
                          <textarea class="form-control" disabled name="sentense" id="sentense"></textarea>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Restitution</label>
                          <textarea class="form-control" disabled name="restitution" id="restitution"></textarea>
                         </div>
                         

                         <div class="form-group">
                          <label for="exampleInputEmail1">Confiscation / Recovery</label>
                          <textarea class="form-control" disabled name="recovery" id="recovery"></textarea>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Fines and Penalties</label>
                          <textarea class="form-control" disabled name="fines" id="fines"></textarea>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Other Orders</label>
                          <textarea class="form-control" disabled name="other" id="other"></textarea>
                         </div>
