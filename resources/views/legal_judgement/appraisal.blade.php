                    ...
                    <div class="card">
                        <form method="post" enctype="multipart/form-data" action="{{ route('get.assign.judgement.legal.appraisal.insert.decision') }}">@csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="decision" disabled  id="decision" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" disabled  name="recommendation">{{@$decision_data->recommendation}}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" disabled  name="court" id="court">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" disabled value="{{@$decision_data->registration_date}}" name="registration_date"> 
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputEmail1">Registration No</label>
                                    <input type="text" class="form-control" disabled value="{{@$decision_data->registration_no}}" name="registration_no"> 
                                </div>
