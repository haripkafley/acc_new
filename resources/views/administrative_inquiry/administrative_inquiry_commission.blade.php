                                ...
                                <tbody>
                                    ...
                                    <tr @if($att->appraise_direcor_status=="IN") style="background-color:red;color:white" @endif>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{route('administrative.inquiry.committe.get.list.page.view.details.page',['type'=>'commission','id'=>@$att->id])}}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                                @else
                                                <a href="{{route('administrative.inquiry.committe.get.list.page.coi.page',['type'=>'commission','id'=>@$att->id])}}" class="btn btn-warning">COI</a>
                                                @endif
