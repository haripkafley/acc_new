                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> 
                        ...
                        <div class="row" style="font-family:Product Sans">
                            <div class="col-sm">
                              MANAGE ADMINISTRATIVE INQUIRY COMMITTEE
                            </div>
                            <div class="col-sm">
                            ...
                            <table id  = "maintable" class="table" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a class="btn btn-xs btn-danger" href="{{route('admistrative.inquiry.committee.list.delete.data',['id'=>$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i></a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="{{route('admistrative.inquiry.committee.list.insert.data')}}">@csrf
