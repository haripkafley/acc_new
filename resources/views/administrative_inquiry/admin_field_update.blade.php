                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                            ...
                                                            <a class="btn btn-xs btn-danger" href="{{route('administrative.inquiry.plan.official.get.list.view.details.view.feild.page.delete.view.delete.person.contact',['id'=>@$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                    ...
                    <div class="card-header" style="font-family:Product Sans"> Details of Documents Collected </div>
                        ...
                        <div class = "card-body">
                            ...
                            <table id  = "maintable" class="table" >
                                ...
                                <div class="col-sm-12">
                    <div class="card card-primary card-outline card-outline-tabs">
                        <form method="post" enctype="multipart/form-data" action="{{route('administrative.inquiry.plan.official.get.list.view.details.feild.review.update.fullpage')}}">@csrf

                                <input type="hidden" name="id"  value="{{@$data->id}}">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Field Visit Date</label>
                                    <input type="date" class="form-control" id="activity" name="activity" aria-describedby="emailHelp" placeholder="Activity" value="{{@$data->start_date}}" disabled>
                                 </div>

                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Visit Location</label>
                                    <input type="text" class="form-control" id="person_contact" name="person_contact" aria-describedby="emailHelp" disabled placeholder="Visit Location" value="{{@$data->location}}">
                                 </div>

                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Activity Description</label>
                                    <textarea type="text" class="form-control" id="document_review" name="document_review" aria-describedby="emailHelp" disabled placeholder="Documents to be reviewed or collected">{{@$data->activity}}</textarea>
                                 </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('administrative.inquiry.plan.official.get.list.view.details.view.feild.page.update.view.insert.person.contact')}}">@csrf
            ...
            <div class="modal fade" id="exampleModaEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('administrative.inquiry.plan.official.get.list.view.details.view.feild.page.update.view.update.person.contact')}}">@csrf
            ...
            <div class="modal fade" id="exampleModa4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('administrative.inquiry.plan.official.get.list.view.details.view.feild.page.update.view.insert.document.collected')}}">@csrf
            ...
            <div class="modal fade" id="exampleModa4_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('administrative.inquiry.plan.official.get.list.view.details.view.feild.page.update.view.update.document.collected')}}">@csrf
