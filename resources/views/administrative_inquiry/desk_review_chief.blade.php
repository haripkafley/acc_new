                        ...
                        <form method="post" enctype="multipart/form-data" action="{{route('administrative.inquiry.plan.official.get.list.view.details.review.update.page.update.full.page')}}">@csrf
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" disabled value="{{@$data->end_date}}" id="end_date" name="end_date" aria-describedby="emailHelp" placeholder="Requested By">
                                 </div>

                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Remarks</label>
                                    <textarea type="text" class="form-control" disabled id="remarks" name="remarks" aria-describedby="emailHelp"  >{{@$data->remarks}}</textarea>
                                 </div>
