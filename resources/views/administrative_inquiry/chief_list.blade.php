                                ...
                                <tbody>
                                    ...
                                    <tr @if($att->appraise_direcor_status=="IN") style="background-color:red;color:white" @endif>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{route('administrative.inquiry.plan.chief.list.view.details.chief',$att->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i></a>

                                                <a href="{{route('administrative.inquiry.plan.chief.add.officials.page',$att->id)}}" class="btn btn-warning mt-2">+ Add Official</a>
