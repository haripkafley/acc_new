...
<div class="card">
    <div class="card-header">
        <font color='#007BFF' size="5.5" face="Product Sans">{{ $cardValuecoi }}</font>
    </div>
    <div class="card-body">
        <p class="p">{{ $firstcoi }}</p>
         <p class="p">{{ $secondcoi }}</p>
          <p class="p">&nbsp;&nbsp;<b>{{ $thirdcoi }}</b></p>
           <p class="p">&nbsp;&nbsp;<b>{{ $fourthcoi }}</b></p>
           <p class="p">&nbsp;&nbsp;{{ $fifthcoi }}</p>
    <br>
