                                    ...
                                    @if (@$data)
                                        ...
                                        @foreach (@$data as $att)
                                            <tr>
                                                ...
                                                <td>
                                                    <p>@if(@$att->status=="") Awaiting @else {{@$att->status}} @endif</p>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" enctype="multipart/form-data" action="{{route('systemic.recommendations.follow.further.action.insert')}}">@csrf
