...
<section class="content">
    ...
    <div class="col-sm-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-danger"
                                                        href="{{ route('systemic.recommendations.follow.delete.review', ['id' => @$att->id]) }}"
            ...
            <form method="post" action="{{route('systemic.recommendations.follow.register.review')}}" enctype="multipart/form-data">
            @csrf
