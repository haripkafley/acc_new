                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> 
                        ...
                        <div class = "card-body">
                            ...
                            <div class="col-sm">
                                 <a href="{{route('systemic.recommendations.registration.add.view',@$case_details->id)}}" class="btn btn-primary">+ Add Data</a>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p>
                                            <a href="javascript:void(0)" class="view_more" style="color:black" data-recom="{{@$value->recommendation}}">{{substr(@$value->recommendation,0,35)}}.. </a>
                                            </p>
                                            @endforeach
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success status" href="javascript:void(0)" data-status="{{@$att->status}}" data-id="{{@$att->id}}" data-status_remark="{{@$att->status_remark}}">Update Status</a>
                                            </td>


                                        <td>
                                           
                                                <a href="{{route('systemic.recommendations.registration.edit.view',$att->id)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>

                                                <a href="{{route('systemic.recommendations.registration.delete.view',$att->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this ?')"><i class="fa fa-trash"></i></a>
