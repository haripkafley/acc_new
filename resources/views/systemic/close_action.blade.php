                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-xs btn-danger"
                                                        href="{{ route('systemic.recommendations.follow.close.model.delete.data', ['id' => @$att->id]) }}"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" enctype="multipart/form-data" action="{{route('systemic.recommendations.follow.close.model.insert.data')}}">@csrf
