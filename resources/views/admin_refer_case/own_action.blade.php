                    ...
                    <div class="modal-content">
                        ...
                        <input type="hidden" name="id" id="id_appraise">
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control" readonly name="status" id="status_edit">
                              <option value="">Select</option>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="organization_div_edit" style="display:none">
                         ...
                         <div class="form-group">
                          ...
                          <textarea class="form-control" readonly name="recomendation_cfd" id="recomendation_cfd"></textarea>
                         </div>


                         <div class="form-group">
                          <label for="exampleInputEmail1">Status</label>
                          <select class="form-control" readonly name="comission_decision" id="comission_decision">
                              <option value="">Select</option>
                              <option value="Closed">Closed</option>
                              <option value="Further Action">Further Action</option>
                              <option value="Own Action">Own Action</option>
