                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.action.taken.by.agency.update.data')}}">@csrf
            ...
            <div class="modal fade" id="status_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.action.taken.by.agency.update.status')}}">@csrf
                        <input type="hidden" name="id" id="id_appraise">
                        
                         <input type="hidden" name="case_id" value="{{@$case_id}}">
                         <div class="form-group">
                          <label for="exampleInputEmail1">Status</label>
                          <select class="form-control" required name="status" id="status_edit" readonly>
                              <option value="">Select</option>
            ...
            <div class="modal fade" id="appraise_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.action.taken.by.agency.update.appraise')}}">@csrf
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Remarks</label>
                          <textarea class="form-control" readonly name="comission_remark" id="comission_remark"></textarea>
                         </div>
