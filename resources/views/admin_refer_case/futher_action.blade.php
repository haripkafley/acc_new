                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.further-action-taken.update.data')}}">@csrf
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name_edit" readonly name="name" aria-describedby="emailHelp">
                         </div>
                        </div>
                        ...
                        <div class="organization_div_edit" style="display:none">
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control" name="action_type" readonly id="action_type_edit" required>
                              <option value="">Select</option>
                         ...
                         <div class="form-group">
                          ...
                          <textarea class="form-control" name="fines" readonly id="fines_edit"></textarea>
                         </div>
            ...
            <div class="modal fade" id="status_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.further-action-taken.update.status')}}">@csrf
            ...
            <div class="modal fade" id="appraise_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.further-action-taken.update.appraise')}}">@csrf
