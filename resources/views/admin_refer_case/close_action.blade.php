                                    ...
                                    @if (@$data)
                                        ...
                                        @foreach (@$data as $att)
                                            <tr>
                                                ...
                                                > Appraise</a></td>
                                                <td>
                                                    <p>@if(@$att->status!="AA"){{@$att->status}}@endif</p>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.close-action-taken.insert.data')}}">@csrf
                <div class="form-group">
                  <label for="exampleInputEmail1">Date of Receipt</label>
                  <input type="date" class="form-control" id="exampleInputEmail1" readonly name="date_receipt" aria-describedby="emailHelp">
                 </div>
                 <input type="hidden" name="case_id" value="{{@$case_id}}">
                 <div class="form-group">
                  <label for="exampleInputEmail1">Action Taken Against</label>
                  <select class="form-control" readonly name="action_taken_against" id="action_taken_against">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" readonly name="cid_document" aria-describedby="emailHelp">
                 </div>

                 <div class="form-group">
                  <label for="exampleInputEmail1">Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" readonly name="name" aria-describedby="emailHelp">
                 </div>
                </div>
                ...
                <div class="organization_div" style="display:none">
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" readonly name="license_no" aria-describedby="emailHelp">
                 </div>

                 <div class="form-group">
                  <label for="exampleInputEmail1">Agency Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" readonly name="agency_name" aria-describedby="emailHelp">
                 </div>
                </div>

                 <div class="form-group">
                  <label for="exampleInputEmail1">Action Type</label>
                  <select class="form-control" name="action_type" readonly required>
                      <option value="">Select</option>
                 ...
                 <div class="form-group">
                  ...
                  <select class="form-control" name="sanction" readonly required>
                      <option value="">Select</option>
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" name="action_taken" readonly></textarea>
                 </div>

                 <div class="form-group">
                  <label for="exampleInputEmail1">Fines and Penalties</label>
                  <textarea class="form-control" name="fines" readonly></textarea>
                 </div>

                 <div class="form-group">
                  <label for="exampleInputEmail1">Action Taken Date</label>
                  <input type="date" class="form-control" id="exampleInputEmail1" readonly required name="action_taken_date" aria-describedby="emailHelp">
                 </div>

                 <div class="form-group">
                  <label for="exampleInputEmail1">Reference Document</label>
                  <input type="file" class="form-control" id="exampleInputEmail1" readonly required name="attachment" aria-describedby="emailHelp">
                 </div>
  ...
  <div class="modal fade" id="exampleModaEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.close-action-taken.update.data')}}">@csrf
                        <input type="hidden" name="id" id="id_edit">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Date of Receipt</label>
                          <input type="date" class="form-control" id="date_receipt_edit"  readonly name="date_receipt" aria-describedby="emailHelp">
                         </div>
                         <input type="hidden" name="case_id" value="{{@$case_id}}">
                         <div class="form-group">
                          <label for="exampleInputEmail1">Action Taken Against</label>
                          <select class="form-control" readonly name="action_taken_against" id="action_taken_against_edit">
                              <option value="">Select</option>
                              <option value="Individual">Individual</option>
                              <option value="Organization">Organization</option>
                          </select>
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">CID / Document No</label>
                          <input type="text" class="form-control" id="cid_document_edit" readonly name="cid_document" aria-describedby="emailHelp">
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Name</label>
                          <input type="text" class="form-control" id="name_edit" name="name" readonly aria-describedby="emailHelp">
                         </div>
                        </div>
                        ...
                        <div class="organization_div_edit" style="display:none">
                         <div class="form-group">
                          <label for="exampleInputEmail1">License No / Registration No</label>
                          <input type="text" class="form-control" id="license_no_edit" readonly name="license_no" aria-describedby="emailHelp">
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Agency Name</label>
                          <input type="text" class="form-control" id="agency_name_edit" readonly name="agency_name" aria-describedby="emailHelp">
                         </div>
                        </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Action Type</label>
                          <select class="form-control" name="action_type" id="action_type_edit" readonly>
                              <option value="">Select</option>
                              <option value="Action1">Action1</option>
                              <option value="Action2">Action2</option>
                          </select>
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Action Sanction</label>
                          <select class="form-control" name="sanction" id="sanction_edit" readonly>
                              <option value="">Select</option>
                              <option value="Sanction1">Sanction1</option>
                              <option value="Sanction2">Sanction2</option>
                          </select>
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Action Taken</label>
                          <textarea class="form-control" id="action_taken_edit" name="action_taken" readonly></textarea>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Fines and Penalties</label>
                          <textarea class="form-control" name="fines" id="fines_edit" readonly></textarea>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Action Taken Date</label>
                          <input type="date" class="form-control" id="action_taken_date_edit"  readonly name="action_taken_date" aria-describedby="emailHelp">
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Update Reference Document</label>
                          <input type="file" class="form-control" id="exampleInputEmail1" readonly  name="attachment" aria-describedby="emailHelp">
                         </div>
            ...
            <div class="modal fade" id="status_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.close-action-taken.update.status')}}">@csrf
                        <input type="hidden" name="id" id="id_appraise">
                        
                         <input type="hidden" name="case_id" value="{{@$case_id}}">
                         <div class="form-group">
                          <label for="exampleInputEmail1">Status</label>
                          <select class="form-control" required name="status" readonly id="status_edit">
                              <option value="">Select</option>
            ...
            <div class="modal fade" id="appraise_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('case.administrative.referrals.followup.close-action-taken.update.appraise')}}">@csrf
                        ...
                        <div class="organization_div_edit" style="display:none">
                         ...
                         <div class="form-group">
                          ...
                          <textarea class="form-control" name="recomendation_cfd" readonly id="recomendation_cfd"></textarea>
                         </div>


                         <div class="form-group">
                          <label for="exampleInputEmail1">Status</label>
                          <select class="form-control" required name="comission_decision" readonly id="comission_decision">
                              <option value="">Select</option>
                              <option value="Closed">Closed</option>
                              <option value="Further Action">Further Action</option>
                              <option value="Own Action">Own Action</option>
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Remarks</label>
                          <textarea class="form-control" name="comission_remark" readonly id="comission_remark"></textarea>
                         </div>
