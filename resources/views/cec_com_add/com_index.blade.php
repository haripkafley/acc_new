                            ...
                            <table id  = "maintable" class="table" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a class="btn btn-xs btn-danger" href="{{route('cec.user.addition.menu.index.delete.user',['id'=>$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="{{route('com.user.addition.menu.index.insert.user')}}">@csrf
