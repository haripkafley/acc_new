            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    ...
                    @if(Auth::user()->role == "Investigator")
                     ...
                     @endif
                        <br>
                        <div class="header" style="height:40px; border-radius:5px; margin-top:10px;">&nbsp;&nbsp;<font color='#000000' size="5.2" face="Product Sans"> Person</font></div>
                                ...
                                @if($entityperson->count())
                                    ...
                                    <tr>   
                                        ...
                                        <td>
                                            ...
                                            <a style="color:grey" href="{{ route('deleteentity',$person->id) }}" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return confirm('Are you sure you want to delete this record?') || event.preventDefault();"><i class="fa fa-trash"></i></a> &nbsp;
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else
                                        ...
                                        <div class  = "form-group">
                                            <label for   = "exampleInputEmail1">CID&nbsp;<font color='red'>*</font></label>
                                                <div class = "input-group">
                                                    <input name="bhutanesecid" id="bhutanesecid" class="form-control" type="text" placeholder="Search CID"/><button class ="search-btn" type="button" onclick="checkcid('{{ $casenoid }}');">Search</button>
                                                </div>    
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="showcitizendetailsnonbhutanese" style="display:none">
                                    ...
                                    <div class= "row"> 
                                        ...
                                        <div class   = "col-md-4">
                                            <div class  = "form-group">
                                                <label for   = "exampleInputEmail1">Date of Birth&nbsp;<font color='red'>*</font></label>
                                                    <input value="1986-10-12" readonly name="nonbhutanesedob" id="nonbhutanesedob"  class="form-control" type="text" />
                                            </div>
                                        </div>
                                    </div>
...
<!-- end -->
<!-- show entity details modal -->
<form  method = "POST" action="{{ route('saveeditentity') }}" enctype="multipart/form-data">
    @csrf 
...
<script>
    ...
    function getDetailsByCID(){
        ...
        function checkcid(casenoid) {
            ...
            var url = '{{ route("checkCIDaddentity", [":cid", ":casenoid"]) }}';
