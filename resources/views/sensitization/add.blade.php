...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
        ...
        <div class = "cards">
        <a href="{{route('sensitization.list.action-list',@$id)}}" class="btn btn-primary" style="float: right;">
                                    Back
         </a>
        </div>
        ...
        <form method="post" action="{{route('sensitization.list.action-list.insert.action')}}" enctype="multipart/form-data">
