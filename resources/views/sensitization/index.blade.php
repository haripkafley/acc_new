        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> Complaints To Be Shared with Agencies for Sensitization </div>
                        <div class = "card-body">
                                ...
                                <tbody>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               ...
                                               <a href="{{route('sensitization.list.action-list',['id'=>@$value->id])}}" class="btn btn-warning">Actions</a>
