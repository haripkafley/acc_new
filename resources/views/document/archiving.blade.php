...
{{-- 
                                                 <a class="btn btn-xs btn-warning return_offence" data-id="{{@$att->id}}" data-file_id="{{@$att->file_id}}" 
                                                data-particular="{{@$att->particular}}" 
                                                data-accessed_by="{{@$att->accessed_by}}" 
                                                data-date="{{@$att->date}}"
                                                data-time="{{@$att->time}}"
                                                data-purpose="{{@$att->purpose}}"
                                                ...
                                                href="javascript:void(0)" data-><i class="fa fa-edit"></i>
                                                 ...
                                                 <a class="btn btn-xs btn-danger" href="{{route('manage.seized.document.get.official.archiving.delete',@$att->id)}}" onclick="return confirm('Are you sure , you want to delete this ? ')"><i class="fa fa-trash"></i>
     ...
     <div class="modal fade" id="offence_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('manage.seized.document.get.official.archiving.insert')}}">@csrf
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control" name="file_id" id="file_id">
                            <option value="">Select</option>
                            @foreach(@$file_document as $value)
                                <option value="{{@$value->id}}">{{@$value->document_no}} (@if(@$value->particular=="D") Document @else File @endif)</option>
                            @endforeach
                           </select>
                         </div>
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="accessed_by" >
                         </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Accessed By</label>
                          <input type="text" class="form-control" name="accessed_by" id="accessed_by">
                         </div>
            ...
            {{-- return --}}
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Document Return Record</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('manage.seized.document.get.official.archiving.return')}}">@csrf
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Accessed By</label>
                          <input type="text" class="form-control" name="issued_to" id="accessed_by_return" disabled>
                         </div>
