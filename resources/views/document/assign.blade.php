            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header" style="font-family:Product Sans">
                            ...
                            <div class="row" style="font-family:Product Sans">
                                ...
                                <div class="col-sm">
                                    ...
                                    <a href="{{route('manage.seized.document.chief')}}" class="btn btn-primary" style="float:right;">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('manage.seized.document.chief.assign.official.assign.user') }}">@csrf
