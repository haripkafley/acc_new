                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                href="javascript:void(0)" data-><i class="fa fa-View"></i>
                                                                Return
                                                 </a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="issued_to" id="issued_to" disabled>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Issued By</label>
                          <input type="text" class="form-control" name="issued_by" id="issued_by" disabled>
                         </div>
                         ...
                         <div class="form-group">
                          ...
                          <textarea type="text" class="form-control" name="purpose" id="purpose" disabled></textarea>
                         </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Issued To</label>
                          <input type="text" class="form-control" name="issued_to" disabled id="issued_to_return" disabled>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Issued By</label>
                          <input type="text" class="form-control" name="issued_by" disabled id="issued_by_return" disabled>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Issue Date</label>
                          <input type="date" class="form-control" name="date" disabled id="date_return" disabled>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Issue Time</label>
                          <input type="time" class="form-control" name="time" disabled id="time_return" disabled>
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Purpose</label>
                          <textarea type="text" class="form-control" name="purpose" disabled id="purpose_return" disabled></textarea>
                         </div>
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="return_by" disabled id="return_by" >
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Return Date</label>
                          <input type="date" class="form-control" name="return_date" disabled id="return_date" >
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Return Time</label>
                          <input type="time" class="form-control" name="return_time" disabled id="return_time" >
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Return Received By</label>
                          <input type="text" class="form-control" name="return_received_by" disabled id="return_received_by" >
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Remarks</label>
                          <textarea type="text" class="form-control" name="remarks"  disabled id="remarks"></textarea>
                         </div>
