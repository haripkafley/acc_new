...
<section class="content">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-info edit_data"
                                                        href="javascript:void(0)" data-receipt="{{ $att->date_receipt }}" data-systemic_chage="{{$att->systemic_chage}}" data-action_taken="{{$att->action_taken}}" data-action_date="{{$att->action_date}}" data-id="{{@$att->id}}"><i class="fa fa-eye"></i>
  ...
  <div class="modal fade" id="exampleModaEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="date_receipt" readonly name="date_receipt" aria-describedby="emailHelp">
                 </div>
                 <input type="hidden" name="case_id" value="{{@$case_id}}">
                 <div class="form-group">
                  <label for="exampleInputEmail1">Recommended Systemic Change</label>
                  <select class="form-control" readonly name="systemic_chage" id="systemic_chage_id">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" name="action_taken" readonly id="action_taken"></textarea>
                 </div>

                 <div class="form-group">
                  <label for="exampleInputEmail1">Action Taken Date</label>
                  <input type="date" class="form-control" id="action_date" readonly name="action_date" aria-describedby="emailHelp">
                 </div>
