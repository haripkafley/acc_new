...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
            ...
            <div class="col-md-12"> @include('systemic_view.common')</div>
                                    ...
                                    @if (@$data)
                                        ...
                                        @foreach (@$data as $att)
                                            <tr>
                                                ...
                                                <td>
                                                    {{@$att->status}}
                                                    <a class="btn btn-success appraise" href="javascript:void(0)" data-status="{{@$att->status}}" data-id="{{@$att->id}}" data-status_remark="{{@$att->status_remark}}">View Status</a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">View Action Taken Record</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('systemic.recommendations.follow.close.model.update.data')}}">@csrf
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control" disabled name="action_taken_against" id="action_taken_against_edit">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" class="form-control" readonly id="cid_document_edit" name="cid_document" aria-describedby="emailHelp">
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Name</label>
                          <input type="text" class="form-control" readonly id="name_edit" name="name" aria-describedby="emailHelp">
                         </div>
                        </div>
                        ...
                        <div class="organization_div_edit" style="display:none">
                         <div class="form-group">
                          ...
                          <input type="text" class="form-control" readonly id="license_no_edit" name="license_no" aria-describedby="emailHelp">
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Agency Name</label>
                          <input type="text" class="form-control" readonly id="agency_name_edit" name="agency_name" aria-describedby="emailHelp">
                         </div>
                        </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Action Type</label>
                          <select class="form-control" name="action_type" id="action_type_edit" disabled>
                              <option value="">Select</option>
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control" name="sanction" id="sanction_edit" disabled>
                              <option value="">Select</option>
                         ...
                         <div class="form-group">
                          ...
                          <textarea class="form-control" id="action_taken_edit" readonly name="action_taken"></textarea>
                         </div>
            ...
            <div class="modal fade" id="status_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('systemic.recommendations.follow.close.model.update-status')}}">@csrf
            ...
            <div class="modal fade" id="appraise_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('systemic.recommendations.follow.close.model.update-appraise')}}">@csrf
                        ...
                        <div class="organization_div_edit" style="display:none">
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Status</label>
                          <select class="form-control" required name="comission_decision" disabled id="comission_decision">
                              <option value="">Select</option>
                              <option value="Closed">Closed</option>
                              <option value="Further Action">Further Action</option>
                              <option value="Own Action">Own Action</option>
