...
<section class="content">
    <div id="casedetailscard" class="container-fluid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              ...
                                              <a class="btn btn-xs btn-danger" href="{{route('monetary.fine.cheif.official.delete.member',['id'=>@$att->id])}}" onclick="return confirm('Are you sure , you want to delete this  ? ')"><i class="fa fa-trash"></i>
                                                                Delete
                                               </a>
                                               @endif
                                        </td>
        ...
        <form method="post" action="{{route('monetary.fine.cheif.add.official.insert.member.insert')}}" enctype="multipart/form-data">
            @csrf
