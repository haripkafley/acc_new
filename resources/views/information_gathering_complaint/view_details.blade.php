    ...
    <div id="casedetailscard" class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <p><b>IG NO :</b> {{@$data->tacktical_details->si_ig_no}}</p>
                </div>
            ...
            <div class="col-sm-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-xs btn-danger"
                                                        href="{{route('information.gathering.complaint.module.chief.view.details.delete.members',@$att->id)}}"
                ...
                <div class="col-sm-12">
                        <div class="card">
                            <form action="{{route('information.gathering.complaint.module.chief.view.details.update.cec.decision.recommendation')}}" enctype="multipart/form-data" method="POST">
                                @csrf
        ...
        <div class="col-sm-12">
            <div class="card" style="padding:25px;">
                        <form action="{{route('information.gathering.complaint.module.chief.view.details.update.commission.decision.recommendation')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{@$id}}">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('information.gathering.complaint.module.chief.view.details.insert.members') }}" enctype="multipart/form-data">@csrf
                                <input type="hidden" name="ig_complaint_id" value="{{@$id}}">
                                <div class="form-group">
            ...
            <div class="modal fade" id="exampleModa3_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('information.gathering.complaint.module.chief.view.details.update.members') }}" enctype="multipart/form-data">@csrf
                                <input type="hidden" name="ig_complaint_id" value="{{@$id}}">
