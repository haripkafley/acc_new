                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header" style="font-family:Product Sans"> 
                        ...
                        <div class="row" style="font-family:Product Sans">
                            <div class="col-sm">
                                Information Gathering Complaint
                            </div>
                           </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{route('information.gathering.complaint.module.chief.view.details',$att->id)}}" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
