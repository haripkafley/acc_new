                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a class="btn btn-xs btn-info edit_bail" data-id="{{@$att->id}}"  href="javascript:void(0)" ><i class="fa fa-edit"></i> + <i class="fa fa-eye"></i>
                                                                
                                                 </a>
                                        
                                                 <a class="btn btn-xs btn-danger" href="{{route('manage.get-assign-official-seized-properties-list.receipt.details.delete.bail',@$att->id)}}" onclick="return confirm('Are you sure , you want to delete this ? ')"><i class="fa fa-trash"></i>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">New Bail and Bond Properties</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data" action="{{route('manage.get-assign-official-seized-properties-list.receipt.details.insert.bail')}}">@csrf
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control security_type" name="security_type">
                         ...
                         <div class="form-group">
                              ...
                              <select class="form-control dzongkhag_add" name="dzongkhag">
                                  <option value="">Select</option>
                         ...
                         <div class="form-group">
                          ...
                          <select class="form-control gewog_add" name="gewog">
                                  <option value="">Select</option>
                          </select>
                         </div>
                         </div>
                         ...
                         <div class="vehicle_div" style="display:none">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <input type="text" name="registered_owner" class="form-control">
                             </div>
                         </div>
                         ...
                         <div class="form-group">
                              ...
                              <input type="text" name="value_property" class="form-control">
                         </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Security Type</label>
                          <select class="form-control security_type" name="security_type" id="security_type">
                              <option value="">Select</option>
                              <option value="Land">Land</option>
                              <option value="Building">Building</option>
                              <option value="Flat">Flat</option>
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Tham No</label>
                          <input type="text" name="tham_no" class="form-control" id="tham_no">
                         </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Plot No</label>
                          <input type="text" name="plot_no" class="form-control" id="plot_no">
                         </div>

                         <div class="form-group">
                              <label for="exampleInputEmail1">Dzongkhag</label>
                              <select class="form-control dzongkhag_add" name="dzongkhag" id="dzongkhag">
                                  <option value="">Select</option>
                                  @foreach(@$dzongkhag as $value)
                                  <option value="{{@$value->dzoID}}">{{@$value->dzoName}}</option>
                                  @endforeach
                         ...
                         <div class="form-group">
                          <label for="exampleInputEmail1">Gewog</label>
                          <select class="form-control gewog_add" name="gewog" id="gewog">
                                  <option value="">Select</option>
                         ...
                         <div class="vehicle_div" style="display:none">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              <label for="exampleInputEmail1">Registered Owner</label>
                              <input type="text" name="registered_owner" id="registered_owner" class="form-control">
                             </div>
                         </div>
                         ...
                         <div class="form-group">
                              <label for="exampleInputEmail1">Value</label>
                              <input type="text" name="value_property" id="value_property" class="form-control">
                         </div>
...
<script type="text/javascript">
    $('.security_type').on('change',function(){
        var secutiry_type = $(this).val();
        // alert(secutiry_type);
        if(secutiry_type=="Land")
        {
        ...
        else if(secutiry_type=="Building")
        {
            $('.commom_land_building_flat').show();
