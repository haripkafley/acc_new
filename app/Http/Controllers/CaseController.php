    ...
    public function generateCaseno(Request $request)
{
    ...
    public function viewcoitogether(Request $request)
    {
        ...
        return view('casefolder.viewcoitogether',compact('casenoid','coifiles','users'));
    }
    ...
    {
        $id = $request->input('id');
        $email = $request->input('newmember');
        $existingemail = $request->input('existinginvemail');
        $casenoid = $request->input('casenoidreplace');
    }
